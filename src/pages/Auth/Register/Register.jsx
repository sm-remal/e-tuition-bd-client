...
const Register = () => {
    ...
    return (
        ...
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950">
             <title>Registration | e-TuitionBD</title>
            ...
            <div className="card-body w-full max-w-md">
                ...
                <form onSubmit={handleSubmit(handleRegistration)}>
                    <fieldset className="fieldset">
                        ...
                        <label className="label text-gray-800 dark:text-gray-200 font-medium">Full Name</label>
                        <input
                            type="text"
                        ...
                        <label className="label text-gray-800 dark:text-gray-200 font-medium mt-3">Upload Photo</label>
                        <input
                            type="file"
                            {...register("photo", { required: true })}
                            
                            className="file-input w-full border border-gray-300 dark:border-gray-600 dark:bg-slate-800 dark:text-gray-300"
                        />
                        {errors.photo && <p className="text-red-500">Photo is required</p>}

                        {/* Email */}
                        
                        <label className="label text-gray-800 dark:text-gray-200 font-medium mt-3">Email Address</label>
                        <input
                            type="email"
                        ...
                        <label className="label text-gray-800 dark:text-gray-200 font-medium mt-3">Phone Number</label>
                        <input
                            type="text"
                            {...register("phone", {
                                required: true,
                        ...
                        <label className="label text-gray-800 dark:text-gray-200 font-medium mt-3">Select Role</label>
                        <select
                            {...register("role", { required: true })}
                            
                            className="select w-full border border-gray-300 dark:border-gray-600 dark:bg-slate-800 dark:text-white"
                        >
                            <option value="" className="dark:bg-slate-800">Choose Role</option>
                            <option value="student" className="dark:bg-slate-800">Student</option>
                            <option value="tutor" className="dark:bg-slate-800">Tutor</option>
                        </select>
                        ...
                        <div className="relative flex items-center">
                            ...
                            <div
                                ...
                                className="absolute right-4 text-gray-600 dark:text-gray-400 cursor-pointer"
                            >
