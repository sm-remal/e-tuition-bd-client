    ...
    return (
        <div className="min-h-scree">
                ...
                <div className="container mx-auto px-4 pt-16 pb-24 md:pt-24 md:pb-32 relative">
                    ...
                    >
                        ...
                        <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                            About <span className="text-cyan-300">eTuitionBd</span>
                        </h1>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
                        {stats.map((stat, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="bg-gradient-to-br from-blue-50 to-cyan-50 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
                        <motion.div {...fadeInUp}>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <div className="flex items-center gap-2 bg-white px-4 py-3 rounded-lg shadow-sm border border-gray-100">
                                    <CheckCircle className="w-5 h-5 text-green-500" />
                                    <span className="font-medium text-gray-700">Verified Tutors</span>
                                </div>
                                <div className="flex items-center gap-2 bg-white px-4 py-3 rounded-lg shadow-sm border border-gray-100">
                                    <CheckCircle className="w-5 h-5 text-green-500" />
                        ...
                        >
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-cyan-200 w-32 h-32 rounded-full -z-10"></div>
                            <div className="absolute -top-6 -left-6 bg-blue-200 w-32 h-32 rounded-full -z-10"></div>
                        </motion.div>
                    </div>
                </div>
            </section>
                            ...
                            {[
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="relative"
                                    >
                                        <div className="bg-gradient-to-b from-blue-50 to-white border border-blue-100 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 h-full">
                        ...
                        {values.map((value, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    {...fadeInUp}
                                    transition={{ delay: index * 0.1 }}
                                    className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:border-blue-200 hover:shadow-xl transition-all duration-300"
                                >
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-4">
                    <motion.div className="text-center mb-16 max-w-3xl mx-auto" {...fadeInUp}>
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 -mt-18">
                    ...
                    <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
                        {features.map((feature, index) => (
                            <motion.div
                                ...
                                className="flex items-start gap-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-100 hover:border-blue-300 transition-colors duration-300"
                            >
